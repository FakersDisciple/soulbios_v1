...
class LightModeColors {
  ...
  static const softDarkGray = Color(0xFF2C2C2C);
  
  // Energy Orb glow colors
  static const warmYellowGlow = Color(0xFFFFC107);
  static const softPinkGlow = Color(0xFFE91E63);
  static const calmBlueGlow = Color(0xFF2196F3);
  static const vibrantGreenGlow = Color(0xFF4CAF50);
  
  // Task panel colors
  static const taskPanelBackground = Color(0xFF3A3A3A);
  static const ritualTaskBackground = Color(0xFF4A4A4A);
  static const taskCheckboxBorder = Color(0xFF999999);
  static const taskTextPrimary = Color(0xFFFFFFFF);
  static const taskTextSecondary = Color(0xFFCCCCCC);
  static const ritualGlowColor = Color(0xFFFFD54F);
}
